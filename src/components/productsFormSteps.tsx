...
<div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-2xl p-6">
  <div className="flex items-center gap-2 mb-4">
    ...
    <h4 className="text-lg font-bold text-gray-900">Warehouse Location</h4>
  </div>
        ...
        {errors.stock.warehouseId.message}
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="text-lg font-bold text-gray-900">Stock Quantity</h4>
            </div>
    ...
    return (
      <div className="space-y-6">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600">Configure variants with custom attributes</p>
        </div>
        ...
        {variantFields?.length > 0 ? (
          <div className="space-y-6">
            {Array.isArray(variantFields) && variantFields?.map((field, variantIndex) => {
              const formData = watch();
              const variant = formData.variants?.[variantIndex];
              const discount = variant?.basePrice && variant?.sellingPrice 
                                ...
                                <button
                                  ...
                                  onClick={async () => {
                                    ...
                                    try {
                                      ...
                                      if (
                                        itemToRemove.file &&
                                        itemToRemove.preview.startsWith("blob:")
                                      ) {
                                        URL.revokeObjectURL(
                                          itemToRemove.preview
                                        );
  ...
  if (currentStep === 5) {
    const formData = watch();
    const discount = calculateDiscount(formData.basePrice, formData.sellingPrice);
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex justify-center">
          <div className={`px-6 py-3 rounded-xl flex items-center gap-2 ${
            productType === "simple"
        ...
        <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 shadow-md">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-start">
              ...
              <span className={`text-sm font-bold ${formData.isActive ? "text-green-600" : "text-gray-500"}`}>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-sm font-semibold text-gray-600">Base Price (MRP):</span>
            ...
            {discount > 0 && (
              <div className="flex justify-between items-center pt-3 border-t-2 border-blue-200">
                ...
                <div className="text-right">
                  <div className="text-xl font-bold text-green-600">{discount}% OFF</div>
                  <div className="text-xs text-green-700">
                    Save ₹{(formData.basePrice - formData.sellingPrice).toFixed(2)}
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            <div className="text-center p-3 bg-white rounded-lg border border-green-200">
              ...
              <div className="text-lg font-bold text-gray-900">{formData.weight || "0"} kg</div>
            </div>
            <div className="text-center p-3 bg-white rounded-lg border border-green-200">
              <div className="text-xs text-gray-600 mb-1">Length</div>
              <div className="text-lg font-bold text-gray-900">{formData.length || "0"} cm</div>
            </div>
            <div className="text-center p-3 bg-white rounded-lg border border-green-200">
              <div className="text-xs text-gray-600 mb-1">Breadth</div>
              <div className="text-lg font-bold text-gray-900">{formData.breadth || "0"} cm</div>
            </div>
            <div className="text-center p-3 bg-white rounded-lg border border-green-200">
              <div className="text-xs text-gray-600 mb-1">Height</div>
              <div className="text-lg font-bold text-gray-900">{formData.height || "0"} cm</div>
            </div>
          </div>
          <div className="bg-white border-2 border-green-300 rounded-xl p-4">
            <div className="flex items-center justify-between">
              <span className="text-sm font-bold text-green-900">Volumetric Weight:</span>
              <span className="text-2xl font-bold text-green-600">
                {calculateVolumetricWeight()} kg
              </span>
            </div>
        ...
        {/* Artisan Information */}
        {(formData.artisanName || formData.artisanAbout || formData.artisanLocation) && (
          <div className="bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-200 rounded-2xl p-6">
            <h4 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
              <User className="h-5 w-5 text-amber-600" />
              Artisan Information
        ...
        {productType === "simple" ? (
          <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 shadow-md">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm font-semibold text-gray-600">Stock Quantity:</span>
                <span className="text-lg font-bold text-green-600">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-2xl p-6">
              ...
              <div className="space-y-4">
                {formData.variants.map((variant: any, index: number) => {
                  ...
                  const hasCustomAttrs = variantAttrs.length > 0 && variantAttrs.some(a => a.key && a.value);
                    ...
                    <div key={index} className="bg-white p-4 rounded-xl border-2 border-purple-200">
                      ...
                      {hasCustomAttrs && (
                        <div className="mb-3 p-3 bg-indigo-50 rounded-lg border border-indigo-200">
                          <div className="text-xs font-semibold text-indigo-900 mb-2">Custom Attributes:</div>
                          <div className="flex flex-wrap gap-2">
                            {variantAttrs
                              .filter(attr => attr.key && attr.value)
                              .map((attr, attrIdx) => (
                                <span key={attrIdx} className="px-2 py-1 bg-white border border-indigo-300 rounded-md text-xs">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-green-800 mb-4">
                Please review all information above. Once submitted, your product will be {formData.isActive ? "immediately visible" : "saved as draft"} in your store.
              </p>
              <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-2 text-sm text-green-700">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span>Product Type: <strong>{productType === "simple" ? "Simple" : "Variable"}</strong></span>
                </div>
                {mediaPreviews.length > 0 && (
                  <div className="flex items-center gap-2 text-sm text-green-700">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span><strong>{mediaPreviews.length}</strong> Media Files</span>
                  </div>
                )}
                {productType === "variable" && formData.variants && (
                  <div className="flex items-center gap-2 text-sm text-green-700">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span><strong>{formData.variants.length}</strong> Variants</span>
                  </div>
                )}
              </div>
            </div>
        ...
        {productType === "variable" && formData.variants && formData.variants.length > 0 && (
          <>
            {formData.variants.some((_:any, idx:number) => {
              const attrs = variantAttributeFields[idx] || [];
              return attrs.length === 0 || !attrs.some(a => a.key && a.value);
            }) && (
              <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border-2 border-amber-200 rounded-2xl p-5">
                <div className="flex items-start gap-3">
                  <Info className="h-5 w-5 text-amber-600 flex-shrink-0 mt-0.5" />
                  <div className="text-sm text-amber-900">
                    <p className="font-semibold mb-1">Note about Custom Attributes</p>
                    <p>
                      Some variants don't have custom attributes. They'll rely on the legacy fields (size, color, fabric) for identification.
                    </p>
                  </div>
                </div>
              </div>
